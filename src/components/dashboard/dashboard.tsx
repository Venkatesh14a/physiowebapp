function Dashboard() {
  return (
    <>
          ...
          <div className="row">
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="service-block">
                <div className="service-img mb20">
                  <a href="#">
                    <img
                ...
                <div className="service-content">
                  ...
                  <p>
                    Write your service content here and describe more in
                    readmore btn. Ibus sapien non rhoncus congue.
                  </p>
                </div>
                {/* service content */}
              </div>
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="service-block">
                ...
                <div className="service-content">
                  ...
                  <p>
                    Write your service content here and describe more in
                    readmore ons velit, a malesuada urna sodales eu.
                  </p>
                </div>
                {/* service content */}
              </div>
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="service-block">
                ...
                <div className="service-content">
                  ...
                  <p>
                    Write your service content here and describe more in
                    readmore ongue ia malesuada urna sodales veliteu.
                  </p>
                </div>
                {/* service content */}
              </div>
      ...
      <div className="space-small bg-primary hidden">
        {/* call to action */}
        <div className="container">
          <div className="row">
            <div className="col-lg-8 col-sm-8 col-md-8 col-xs-12">
              ...
              <p className="cta-text">
                {" "}
                Call to action button example for booking appointment for
                patients.
              </p>
            </div>
            <div className="col-lg-4 col-sm-4 col-md-4 col-xs-12">
              <a href="#" className="btn btn-white btn-lg mt20">
      ...
      {/* /.call to action */}
      <div className="space-medium hidden">
        <div className="container">
          <div className="row">
          ...
          <div className="row">
            <div className="col-lg-3 col-sm-3 col-sm-6 col-xs-12">
              <div className="team-block">
                {/* team block start*/}
                <div className="team-img">
                  <img src="src/assets/images/team-1.jpg" />
                </div>
                <div className="team-content">
                  <h2 className="team-title">Dr.Sylvia Rosas</h2>
            ...
            <div className="col-lg-3 col-sm-3 col-sm-6 col-xs-12">
              <div className="team-block">
                ...
                <div className="team-content">
                  <h2 className="team-title">Dr.Ray Wilford</h2>
                  <div className="team-meta">
                    <span className="team-designation">Physician</span>
                  </div>
                </div>
              </div>
              {/* team block end */}
            ...
            <div className="col-lg-3 col-sm-3 col-sm-6 col-xs-12">
              <div className="team-block">
                {/* team block start*/}
                <div className="team-img">
                  <img src="src/assets/images/team-3.jpg" />
                </div>
                <div className="team-content">
                  <h2 className="team-title">Dr.Donna Handy</h2>
                  <div className="team-meta">
                    <span className="team-designation">
                      Consultant Physician
                    </span>
            ...
            <div className="col-lg-3 col-sm-3 col-sm-6 col-xs-12">
              <div className="team-block">
                {/* team block start*/}
                <div className="team-img">
                  <img src="src/assets/images/team-4.jpg" />
                </div>
                <div className="team-content">
                  <h2 className="team-title">Dr.Terry Cruz</h2>
                  <div className="team-meta">
                    <span className="team-designation">Physician</span>
                  </div>
                </div>
              ...
              <div className="testimonial-block">
                ...
                <div className="testimonial-content">
                  <p className="testimonial-text">
                    ...
                    Wouldn't go anywhere Thanks to the wonderful staff! vitae
                    odio non luctus cum sociis natoque penatibus et magnis dis
                    parturient montes nascetur ridiculus mus in tempor.”
                  </p>
                </div>
                <div className="testimonial-info">
                  <h4 className="testimonial-name">Rose Jacq</h4>
                  <span className="testimonial-meta">34 Year</span>
                </div>
              </div>
              {/*/. testimonial block */}
            </div>
            ...
            <div className="col-lg-4 col-md-4 col-sm-6 col-xs-12">
              <div className="post-block">
                ...
                <div className="post-img">
                  <a href="#">
                    <img
                      src="src/assets/images/post-img.jpg"
                      alt=""
                      className="img-responsive"
                    />
                  </a>
                ...
                <div className="post-content">
                  <h2>
                    <a href="#" className="title">
                      {" "}
                      Free Physiotherapy Website Templates Download
                    </a>
                  </h2>
                  <p className="meta">
                    {" "}
                    <span className="meta-date">
                      <i className="fa fa-calendar"></i> 1 January 2017
                    </span>{" "}
            ...
            <div className="col-lg-4 col-md-4 col-sm-6 col-xs-12">
              <div className="post-block">
                ...
                <div className="post-img">
                  <a href="#">
                    <img
                      src="src/assets/images/post-img-1.jpg"
                      alt=""
                      className="img-responsive"
                    />
                  </a>
                ...
                <div className="post-content">
                  <h2>
                    <a href="#" className="title">
                      {" "}
                      Hospital Website Templates FREE Download
                    </a>
                  </h2>
                  <p className="meta">
                    {" "}
                  ...
                  <p>
                    ...
                    massa commodo, viverra nibh a, iaculis velit.
                  </p>
                  <a href="#" className="btn btn-default">
                    Read More
                  </a>{" "}
              ...
              <div className="post-block">
                ...
                <div className="post-content">
                  <h2>
                    <a href="#" className="title">
                      {" "}
                      Free Website Templates for Physiotherapy
                    </a>
                  </h2>
                  <p className="meta">
                    {" "}
                  ...
                  <p>
                    Suspendisse quis ultrices felis. Nunc dictum justo sed
                    libero cursus mattis. Phasellus vestibulum eleifend velit id
                    ultricies.
                  </p>
                  <a href="#" className="btn btn-default">
                    Read More
