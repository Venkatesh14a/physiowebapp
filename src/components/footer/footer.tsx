                ...
                <div className="col-lg-4 col-md-2 col-sm-2 col-xs-12">
                    <div className="footer-widget footer-social">
                        ...
                        <ul className="listnone contact">
                            <li><i className="fa fa-map-marker"></i> 8-2-703, 4/A, Road No. 12, opp. Asian Vascular Hospital, Sai Enclave, Bhola Nagar, Banjara Hills, Hyderabad, Telangana 500034
                            </li>
                            <li><i className="fa fa-phone"></i> +91 9000095336</li>
                            <li><i className="fa fa-envelope-o"></i> info@gastrology.com</li>
                        </ul>
                    </div>
                </div>
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div className="copyright-content">
                 Shared by <i className="fa fa-love"></i><a href="https://bootstrapthemes.co">BootstrapThemes</a>
                </div>
              </div>
            </div>
          </div>
